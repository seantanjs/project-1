...
///////////// Everything below here is non-MVP - 2 match rule////////////

//give player option to play 2 match rule or 3 match rule
var response = prompt("Do you want to play 2 match rule or 3 match rule?");
...
var flip = function(event) {
    ...
    if(len === 3) {
        ...
        //if the 1st opened card and the 2nd opened card has the same image, then we call the matched function
        if(openedCards[0].querySelector("img").src === openedCards[1].querySelector("img").src && openedCards[0].querySelector("img").src === openedCards[2].querySelector("img").src && openedCards[1].querySelector("img").src === openedCards[2].querySelector("img").src) {
            matched();
        } //else if there is no match, we call the unmatched function
        else {
            unmatched();
...
var checkWinStatus = function() {
//initialize no of images pairs which determines the win condition
    var noOfPairsOfImages = (document.querySelectorAll("td").length / 3);
    if(matchedPairs.length == noOfPairsOfImages) {
        alert("You won!");
    }
...
var matched = function() {
    ...
    openedCards[0].style.visibility = "hidden";
    openedCards[1].style.visibility = "hidden";
    openedCards[2].style.visibility = "hidden";
    openedCards[0].querySelector("img").style.visibility = "hidden";
    openedCards[1].querySelector("img").style.visibility = "hidden";
    openedCards[2].querySelector("img").style.visibility = "hidden";
